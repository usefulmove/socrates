...
To learn more, visit the [“glob (programming)” Wikipedia page](https://en.wikipedia.md/wiki/Glob_(programming)).
...
DuckDB's globbing implementation follows the semantics of [Python's `glob`](https://docs.python.md/3/library/glob.html) and not the `glob` used in the shell.
